...
// yaml-editor-src.js
var yamlHighlightStyle = HighlightStyle.define([
...
var editorView = null;
var usingTextareaFallback = false;
var fallbackTextarea = null;
function activateTextareaFallback(parent, initialValue, readOnly2) {
  ...
  textarea.readOnly = !!readOnly2;
  parent.appendChild(textarea);
  fallbackTextarea = textarea;
}
async function createYamlEditor(parent, initialValue, readOnly2) {
  destroyYamlEditor();
  if (!parent) {
    return null;
  }
  try {
    ...
    activateTextareaFallback(parent, initialValue, readOnly2);
    return null;
  }
}
