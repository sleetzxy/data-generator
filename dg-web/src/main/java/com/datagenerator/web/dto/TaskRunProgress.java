...
public class TaskRunProgress {
    ...
    public TaskRunProgress() {
    }

    public TaskRunProgress(int totalTables, int completedTables, long totalRows, long writtenRows, long failedRows) {
