...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleBadRequest(RuntimeException exception) {
        ...
        return ResponseEntity.badRequest()
                .body(new ErrorResponse(
                        HttpStatus.BAD_REQUEST.value(), resolveMessage(exception)));
    }
    ...
    public ResponseEntity<ErrorResponse> handleAiUnavailable(
        ...
        return ResponseEntity.status(HttpStatus.SERVICE_UNAVAILABLE)
                .body(new ErrorResponse(
                        HttpStatus.SERVICE_UNAVAILABLE.value(), resolveMessage(exception)));
    }
    ...
    public ResponseEntity<ErrorResponse> handleIllegalState(IllegalStateException exception) {
        ...
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                .body(new ErrorResponse(
                        HttpStatus.INTERNAL_SERVER_ERROR.value(), resolveMessage(exception)));
    }
